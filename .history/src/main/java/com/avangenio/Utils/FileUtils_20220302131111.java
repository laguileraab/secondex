...
public class FileUtils {
    ...
    String route, f1, f2, IDF, separator = "";
    ...
    public FileUtils(String route, String f1, String f2, List<Data> datas, String IDF, String separator) {
        this.route=route;
        this.f1=f1;
        this.f2=f2;
        this.datas=datas;
    ...
    public static String ReadFile(String route) throws FileNotFoundException {
        String file = "";
