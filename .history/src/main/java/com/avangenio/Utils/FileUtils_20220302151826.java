...
public class FileUtils {
    ...
    public static FileUtils fetchData(FileUtils fileUtils, String route) throws FileNotFoundException {
        ...
        datasf2.addAll(FileUtils.ReadFields(f2, "F2", datas, " ; ")); // Store in object data f2
        datas = FileUtils.FormatID(datasAux, "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]-[A-Z]"); // Format id for f2                                                                          // format
